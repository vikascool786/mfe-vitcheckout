...
const Product: React.FC<ProductProps> = React.memo(
  ({ prodPosition, productData: pData, baseUrl }) => {
    const [selectedPermutation, setSelectedPermutation] =
      useState<string | number | object>("");
    const [currentPrice, setCurrentPrice] =
      useState<string | number | object>("$0.00");
    ...
    return (
      <div
        className={`qa-product-card product-container full`}
