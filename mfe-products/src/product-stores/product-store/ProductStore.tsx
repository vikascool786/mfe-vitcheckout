...
const ProductStore: React.FC<ProductStoreProps> = ({
  ...
  return (
    <div
      className={`qa-store-card product-store-container ${
    ...
    >
      ...
      <div className="product-store-link">
        {pData.derived.isLinkOff ? (
          <button className="qa-button mfe-button" onClick={openShopSite}>
            Shop Site{" "}
          ...
          <button className="qa-button mfe-button" onClick={openShopStore}>
            Shop Store
          </button>
        )}
      </div>
