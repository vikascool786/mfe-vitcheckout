...
export const fetchCustomerProfileData = async (
    ...
    try {
        const customerProfileEndpoint = `${GET_API_ENDPOINT_BASE_URL_ONLY()}/customer-profile-alt-service/v1/profiles/customers/${pcid}?api_key=${GET_API_KEY()}`;
        ...
        throw new Error("Customer profile not retrieved");
    }
};