...
export const DropdownField: React.FC<DropdownProps> = ({ options, label, required, selectedValue }) => {
    ...
    return (
        <div className="field-item-container">
            ...
            <select className="input-container" value={selectedOption} onChange={handleSelectChange}>
                {options.map((option) => (
