        ...
        <div className="addresslist">
            {addressList.map((add, index) => (
                <div
                    ...
                    className={`addresslist-container addresslist-container__avs ${index == 0 && "start"
                        } ${selectedAddress.id === add.id && "selected"}`}
                >
                    <RadioButton
                        id={String(index + 1)}
                        name={"avs-select"}
            ...
            <div
                className={`addresslist-container addresslist-container__avs end ${selectedAddress.id === addressToVerify.id && "selected"
                    }`}
